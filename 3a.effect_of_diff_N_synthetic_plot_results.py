...
param = np.load('sim_data/3a.eff_N_synthetic_param_mp.npy')
## Load data of each N
cdiego_m_Na = np.load('sim_data/3a.eff_Na_synthetic_data_mp.npy')
cdiego_m_Nb = np.load('sim_data/3a.eff_Nb_synthetic_data_mp.npy')
cdiego_m_Nc = np.load('sim_data/3a.eff_Nc_synthetic_data_mp.npy')
...
plt.semilogy(cdiego_m_Na[start_t:end_t], label='NFC, $N = $'+str(Na)+', alpha = '+str(step_size_Na), linestyle='solid',linewidth=1,marker='^',markersize=4, markevery=markers_on.tolist())
plt.semilogy(cdiego_m_Nb[start_t:end_t], label='NFC, $N = $'+str(Nb)+', alpha = '+str(step_size_Nb), linestyle='solid',linewidth=1,marker='^',markersize=4, markevery=markers_on.tolist())
plt.semilogy(cdiego_m_Nc[start_t:end_t], label='NFC, $N = $'+str(Nc)+', alpha = '+str(step_size_Nc), linestyle='solid',linewidth=1,marker='^',markersize=4, markevery=markers_on.tolist())
