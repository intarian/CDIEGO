...
plt.plot(cdiego_m_FC_ega[start_t:end_t], label='FC, $\Lambda: $'+str(eigen_gap_a), linestyle='solid',linewidth=1,marker='^',markersize=7, markevery=markers_on.tolist())
plt.plot(cdiego_m_T_opt_ega[start_t:end_t], label='NFC, Tc = '+ ' $T_{mix} (3/2) \log(Nt)$: '+str(T_opt)+', $\Lambda: $'+str(eigen_gap_a),linestyle='dashed',linewidth=1,marker='o',markersize=7, markevery=markers_cdiego_opt.tolist())
plt.plot(cdiego_m_FC_egb[start_t:end_t], label='FC, $\Lambda: $'+str(eigen_gap_b), linestyle='solid',linewidth=1,marker='^',markersize=7, markevery=markers_on.tolist())
plt.plot(cdiego_m_T_opt_egb[start_t:end_t], label='NFC, Tc = '+ ' $T_{mix} (3/2) \log(Nt)$: '+str(T_opt)+', $\Lambda: $'+str(eigen_gap_b),linestyle='dashed',linewidth=1,marker='o',markersize=7, markevery=markers_cdiego_opt.tolist())
plt.plot(cdiego_m_FC_egc[start_t:end_t], label='FC, $\Lambda: $'+str(eigen_gap_c), linestyle='solid',linewidth=1,marker='^',markersize=7, markevery=markers_on.tolist())
plt.plot(cdiego_m_T_opt_egc[start_t:end_t], label='NFC, Tc = '+ ' $T_{mix} (3/2) \log(Nt)$: '+str(T_opt)+', $\Lambda: $'+str(eigen_gap_c),linestyle='dashed',linewidth=1,marker='o',markersize=7, markevery=markers_cdiego_opt.tolist())
plt.yscale("log")
plt.xscale("log")
